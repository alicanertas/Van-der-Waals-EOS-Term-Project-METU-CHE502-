...
def calc_binodal_points(name):
    ...
    while i < len(T):
        ...
        print(T[i], P_sat[i]/100000, V_sat_L[i]*1000000, V_sat_V[i]*1000000)
        i += 1
...
def calc_spinodal_points(name):
    ...
    while i < len(T):
        ...
        print(T[i], P_min[i]/100000, V_min[i]*1000000, P_max[i]/100000, V_max[i]*1000000)
        i += 1
